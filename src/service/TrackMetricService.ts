...
export async function parseTrackMetrics(tracks:any): Promise<TrackMetricsSchema>{
  return {
    trackId: tracks.id,
...
export async function mapTrackMetrics(tracks: any): Promise<TrackMetricsSchema[]> {
  return tracks
...
export async function getTrackMetric(trackId:number): Promise<TrackMetricsSchema> {
